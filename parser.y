...
%token <val> AND OR NOR ADD ADDU SUB SUBU JR SLTU BEQ BNEQ SLL SRL LW LBU LHU LUI SLTI SLTIU SB SH SW SLT ANDI ORI ADDI ADDIU J JAL NOP MOVE CLEAR
%token <name> LABEL
...
instruction   : AND REG',' REG',' REG { cmd_r($1, $4, $6, $2, 0) }
              ...
              | NOP { cmd_i(SLL, 0, 0, 0, "") }
              | MOVE REG',' REG { cmd_r(ADD, $4, 0, $2, 0) }
              | CLEAR REG { cmd_r(ADD, 0, 0, $2, 0) }
              ;
